const DICT = Object.freeze({
    zh: {
        ...
        'sessions.resume.nativeUnavailableTitle': '会话不在原生目录中，恢复可能失败',
        'sessions.derivedBadge': '派生',
        'sessions.convertedFrom': '转换自 {source}',
        'sessions.nativeAvailable': '原生可用：{value}',
        'common.yes': '是',
        'common.no': '否',
    ...
    en: {
        ...
        'sessions.resume.nativeUnavailableTitle': 'Session not in native directory, resume may fail',
        'sessions.derivedBadge': 'Derived',
        'sessions.convertedFrom': 'Converted from {source}',
        'sessions.nativeAvailable': 'Native Available: {value}',
        'common.yes': 'Yes',
        'common.no': 'No',
